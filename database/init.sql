...
('Mike Johnson', 'IT', 82000.00, 'Network monitoring logs stored in /network-logs/admin_traffic.pcap directory'),
...
('Ashley Wilson', 'Marketing', 70000.00, 'Network monitoring logs stored in /network-logs/network_analysis.log directory'),
